  <form id="quote_form" action="<?= get_template_directory_uri() . '/assets/forms/contact.php' ?>" method="post" role="form" class="php-email-form mt-4">

    <div class="form_header">
      <p class="form_header_content">Envie seu pedido de orçamento:</p>
    </div><!-- end form header -->
